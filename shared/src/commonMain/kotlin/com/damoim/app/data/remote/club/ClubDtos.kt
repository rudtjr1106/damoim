...
@Serializable
data class BoardPreviewDto(val category: String, val title: String, val commentCount: Int = 0)
...
internal fun HomeSummaryResponseDto.toDomain(): HomeSummary = HomeSummary(
    ...
    boardPreviews = boardPreviews.map { BoardPreview(boardCategory(it.category), it.title, it.commentCount) },
